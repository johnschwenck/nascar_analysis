...
# │   ├── nascar_model_pipeline.py          # Main ML pipeline class (fully modular)
# │   ├── utils.py                          # Utility functions (for web scraping & feature engineering)
# │
# ├── data/                                 # Input dataset
# │   └── cup_race_results_2014_2024.csv
# │
# ├── outputs/                              # Results generated by the pipeline
# │   ├── leaderboard.csv                   # Model performance leaderboard
# │   ├── over_under_performance.csv        # Over/Under Performance Report
# │   ├── championship_comparison.csv       # Model vs. Actual Champions
